"""Phase 2.5 MED: expiring_arr respects CURRENCY_CODE (multicurrency guard).
...
def test_marker_adoptiq_backend_py() -> None:
    ...
    assert 'Round 8 / Phase 2.5' in src, 'Round 8 marker missing in adoptiq_backend.py: Round 8 / Phase 2.5'
    assert 'CURRENCY_CODE' in src, 'Round 8 pattern missing in adoptiq_backend.py: CURRENCY_CODE'
