"""Phase 2.2 MED: subsection_errors / comparison.fetch_error use error_kind not str(e).
...
def test_marker_adoptiq_backend_py() -> None:
    ...
    assert 'Round 8 / Phase 2.2' in src, 'Round 8 marker missing in adoptiq_backend.py: Round 8 / Phase 2.2'
    assert 'error_kind' in src, 'Round 8 pattern missing in adoptiq_backend.py: error_kind'
