"""Phase 2.3 HIGH: residual CURRENT_DATE() replaced with explicit Python-bound UTC dates.
...
def test_marker_adoptiq_backend_py() -> None:
    ...
    assert 'Round 8 / Phase 2.3' in src, 'Round 8 marker missing in adoptiq_backend.py: Round 8 / Phase 2.3'
    assert 'UTC' in src, 'Round 8 pattern missing in adoptiq_backend.py: UTC'
