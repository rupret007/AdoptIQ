"""Phase 1.10 MED: download_file uses realpath containment + canonical safe path.
...
def test_marker_app_simple_py() -> None:
    ...
    assert 'Round 8 / Phase 1.10' in src, 'Round 8 marker missing in app_simple.py: Round 8 / Phase 1.10'
    assert 'realpath' in src, 'Round 8 pattern missing in app_simple.py: realpath'
