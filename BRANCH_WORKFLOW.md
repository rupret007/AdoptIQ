...
1. `make verify` (runs `pytest`, `ruff check`, `bandit -ll`, and `pip-audit -r requirements.txt` — all gates must pass; current baseline is **6251+ passed / 4 skipped** at Round 132 / Build 102 close-out)
