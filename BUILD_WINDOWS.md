...
> **Pre-build sanity check (recommended).** Run `make verify` before building so you catch test/lint/security/audit regressions on the source tree before they ship in a binary. Current baseline (Round 48 / Build25 close-out): 3191 passed / 2 skipped, ruff clean, no HIGH/MED bandit findings, no pip-audit vulns.
