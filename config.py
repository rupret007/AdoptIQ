...
class Config:
    ...
    CIRCUIT_CONFIG = {
        ...
        "model_name_ask_ai": (
            ...
            or os.environ.get('CIRCUIT_MODEL_NAME', 'gpt-5-nano')
        ),  # Round 69 / Build 43
        "model_name_report": (
